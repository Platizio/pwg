  ...
  return (
    <div className="flex flex-col gap-8 px-6 py-6 lg:gap-9">
      {/* Newswire leads the rail.
          ...
          breakpoint this whole rail is appended beneath the main column, so
          "last in the rail" meant 6,277px into a 7,807px page — eighty per
      ...
      <section>
        ...
        {/* Headlines, ruled apart.
            ...
            everywhere else. */}
        {/* An empty rail is a real answer now, not a failure.

            The feed tags an article with every ticker it names, so a company
            almost always has "news" — it is just that the news is a Vanguard
