...
export function PopularRibbon({ rows }: { rows: Quote[] }) {
  ...
  /* Doubled from the merged list, not the raw one: both halves of the marquee
     are the same cells at two points in the loop, and a visible half showing a
     newer price than its aria-hidden twin would be one strip contradicting
     itself. */
