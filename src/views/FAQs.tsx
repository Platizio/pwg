      ...
      <section className="page-hero">
        <div className="container">
          <div className="breadcrumb">
            <Link href="/">Home</Link><span className="crumb-sep" aria-hidden="true">/</span><span>FAQs</span>
          </div>
          ...
          <div className="container">
            <div className="faq-featured">
              ...
              <p className="faq-featured-more">
                Not here? <Link href="/help">Ask the support assistant</Link>, or read
                every answer below.
              </p>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="regs-cta faq-cta">
            ...
            <div className="faq-cta-actions">
              <Link className="btn btn-gold btn-lg" href="/help">
                Ask the assistant
