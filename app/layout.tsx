...
/* A default, not an assertion. This layout now wraps the marketing site as
   well as the terminal, and each site page supplies its own title and
   description through <SEO>, which React hoists into <head>. The terminal's
   own metadata lives in app/terminal/layout.tsx. */
export const metadata: Metadata = {
  title: { default: "Platizio Global", template: "%s" },
  description:
    "Invest in US stocks and ETFs from India, under IFSCA regulation in GIFT City.",
};
